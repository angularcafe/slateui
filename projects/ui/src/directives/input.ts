...
const inputVariants = tv({
  base: [
    ...
    'aria-invalid:ring-destructive/20 [&[data-touched][data-invalid]]:ring-destructive/20 [&[data-touched][data-invalid]]:border-destructive dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive',
  ].join(' '),
});
