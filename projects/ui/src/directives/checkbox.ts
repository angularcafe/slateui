import { computed, Component, input, ChangeDetectionStrategy, model, booleanAttribute, output } from "@angular/core";
...
@Component({
    ...
    template: `<button ngpCheckbox [(ngpCheckboxChecked)]="checked" [class]="computedClass()" [ngpCheckboxDisabled]="disabled()" [ngpCheckboxRequired]="required()" [ngpCheckboxIndeterminate]="indeterminate()">
    @if (checked()) {
