...
@Directive({
    ...
    hostDirectives: [{
        ...
        outputs: [
            'ngpTabsetValueChange: uiTabsValueChange'
        ]
    }],
    host: {
        '[class]': 'computedClass()'
