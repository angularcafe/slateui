...
export class UiDropdownMenuItem {
    inputClass = input<string>('', { alias: 'class' });
    computedClass = computed(() => dropdownMenuItem({ class: this.inputClass() }));
}
...
export class UiDropdownMenuShortcut {
    inputClass = input<string>('', { alias: 'class' });
    computedClass = computed(() => dropdowMenuShortcut({ class: this.inputClass() }));
}
...
export class UiDropdownMenuSeparator {
    inputClass = input<string>('', { alias: 'class' });
    computedClass = computed(() => dropdownMenuSeparator({ class: this.inputClass() }));
}
...
export class UiDropdownMenuLabel {
    inputClass = input<string>('', { alias: 'class' });
    computedClass = computed(() => dropdownMenuLabel({ class: this.inputClass() }));
}
