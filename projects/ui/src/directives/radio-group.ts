...
const radioGroupVariants = tv({
  slots: {
    ...
    indicator:
      'size-2 rounded-full absolute top-1/2 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2 data-[checked]:bg-primary',
  },
});
  ...
  hostDirectives: [
    {
      ...
      outputs: ['ngpRadioGroupValueChange: defaultValueChange'],
    },
  ],
})
