...
import { injectTooltipTriggerState, NgpTooltip, NgpTooltipArrow, NgpTooltipTrigger } from "ng-primitives/tooltip";
...
const tooltipVariants = tv({
    slots: {
        ...
        tooltipTrigger: '',
        tooltipArrow: 'absoulte bg-primary fill-primary z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]',
    }
});
