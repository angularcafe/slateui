...
import { UiDialog, UiDialogDescription, UiDialogFooter, UiDialogHeader, UiDialogOverlay, UiDialogTitle, UiDialogTrigger } from 'ui';
...
@Component({
        ...
        <div uiDialogOverlay>
            <div uiDialog>
                <div uiDialogHeader>
                    ...
                    <button uiButton variant="ghost" size="sm" (click)="close()"><ng-icon name="lucideX"
                            size="18px"></ng-icon></button>
  ...
  imports: [UiDialog, UiDialogHeader, UiDialogTitle, UiDialogDescription, UiDialogFooter, UiDialogTrigger, UiDialogOverlay, UiButton, NgIcon]
})
...
export const dialogMeta: IComponentMeta = {
  ...
  api: {
    props: [
      { name: 'uiDialogTrigger', type: 'TemplateRef', description: 'Template ref for dialog content.' },
      { name: 'uiDialogModal', type: 'boolean', description: 'Whether the dialog is modal.' },
