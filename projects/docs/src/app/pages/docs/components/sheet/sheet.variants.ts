...
@Component({
  ...
  template: `
    <button uiButton variant="outline" [uiSheetTrigger]="sheet">
      Custom Size
    </button>
    <ng-template #sheet let-close="close">
      <div uiSheetOverlay>
    ...
    props: [
      {
        name: 'uiSheetTrigger',
        type: 'TemplateRef',
        description: 'Template ref for sheet content.',
      },
      {
        name: 'uiSheetModal',
        type: 'boolean',
...
export const sheetVariants: IVariant[] = [
  {
    title: 'Default',
    description:
      'Basic sheet with header, content, and footer. Slides in from the right by default.',
