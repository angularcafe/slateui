    ...
    <form (ngSubmit)="onSubmit()">
      <div class="grid items-center gap-1.5" uiFormField>
        ...
        <textarea
          ...
          required
        ></textarea>
        <p uiDescription>Tell us a little bit about yourself</p>
      </div>
    ...
    props: [
      {
        name: 'uiTextarea',
        type: 'Directive',
        description: 'Textarea directive for styling and functionality.',
      },
      {
        name: 'placeholder',
        type: 'string',
...
export class TextareaWithButtonExample {
  ...
  },
  {
    title: 'Form',
    description:
      'Complete form with textarea using ngModel and form field directives.',
    code: `import { UiTextarea } from '@workspace/ui/directives/textarea';
import { UiButton } from '@workspace/ui/directives/button';
