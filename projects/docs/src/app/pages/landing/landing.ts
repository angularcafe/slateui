  ...
  features = [
    {
      ...
      description: 'Built with the latest Angular features including Signals, standalone components, and modern architecture. Leveraging Angular Primitives for robust, accessible foundation and exceptional developer experience.',
